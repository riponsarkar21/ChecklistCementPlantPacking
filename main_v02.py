...
# Create a canvas and scrollbar to make the form scrollable
...
# Load the questions to display in the form
...
for idx, question in enumerate(questions, start=1):
    ...
    label = tk.Label(frame, text=question, wraplength=300)  # Wrap the text to prevent overflow
...
# Date Picker (placed outside the scrollable area)
...
# Shift Picker (placed outside the scrollable area)
...
# Submit Button (placed outside the scrollable area)
